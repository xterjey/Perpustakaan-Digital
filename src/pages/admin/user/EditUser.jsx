...
import useUserEdit from '../../../hooks/admin/useUserEdit';
...
const EditUser = () => {
  ...
  const { formData, loading, handleChange, updateDataPengguna, error } = useUserEdit(userID);
    ...
    <div className="wrapper">
      ...
      <div className="main">
        ...
        <div className="content">
          <h2 className="mb-4">Edit Data Pengguna</h2>
